                    ...
                    <div class="card">
                        ...
                        <form action="" method="post">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="smtp_host" id="smtp_host" value="<?= $credentials['smtp_host'] ?? '' ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group mb-3">
                                <label for="smtp_port" class="form-label">SMTP Port</label>
                                <input type="text" name="smtp_port" id="smtp_port" value="<?= $credentials['smtp_port'] ?? '' ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group mb-3">
                                <label for="smtp_email" class="form-label">SMTP Email</label>
                                <input type="email" name="smtp_email" id="smtp_email" value="<?= $credentials['smtp_email'] ?? '' ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group mb-3">
